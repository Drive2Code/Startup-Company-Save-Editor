...
![GitHub Release](https://img.shields.io/github/v/release/Drive2Code/Startup-Company-Save-Editor)
![GitHub License](https://img.shields.io/github/license/Drive2Code/Startup-Company-Save-Editor)
...
Startup Company Save Editor is the first and most powerful graphical save file editor for the game Startup Company. This game save modifier allows you to easily edit balance, research points, employees, and inventory, giving you complete control over your gameplay experience. It's the ultimate save editor for anyone looking to modify their Startup Company save files.

![Main Window](screenshots/SaveEditorTitle.png)

![Main Window](screenshots/Employees.png)

![Main Window](screenshots/Inventory.png)
...
![GitHub Downloads (latest release)](https://img.shields.io/github/downloads/Drive2Code/Startup-Company-Save-Editor/latest/total)
![GitHub Repo stars](https://img.shields.io/github/stars/Drive2Code/Startup-Company-Save-Editor)
